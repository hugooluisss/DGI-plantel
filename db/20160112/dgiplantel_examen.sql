...
CREATE TABLE `examen` (
  ...
  `estado` varchar(45) DEFAULT 'a' COMMENT 'a: aplicando en plantel; t: finalizado',
...
INSERT INTO `examen` VALUES (15,'Examen de prueba','Esta es una prueba','Agosto 2015',1800,'E','10');
