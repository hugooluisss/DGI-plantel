<?php /* Smarty version Smarty-3.1.11, created on 2016-06-01 12:18:19
         compiled from "templates/plantillas/layout/registro.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1540725749574f13c62b5a42-37725917%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1540725749574f13c62b5a42-37725917',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_574f13c652a6b2_89308545',
  'variables' => 
  array (
    'PAGE' => 0,
    'script' => 0,
...
<?php if ($_valid && !is_callable('content_574f13c652a6b2_89308545')) {function content_574f13c652a6b2_89308545($_smarty_tpl) {?><!DOCTYPE html>
<html>
	<head>
	<meta charset="utf-8">
	...
	<body class="hold-transition login-page">
		<div class="login-box">
			<div class="login-logo">
				<a href="index.php">DGI</a>
			</div><!-- /.login-logo -->
		<div class="login-box-body">
			<p class="login-box-msg">Bienvenido, para poder iniciar es necesario el que crees una cuenta de administrador en el sistema</p>
			<form action="#" id="frmRegistro" method="post">
				...
				<div class="form-group has-feedback">
					<input type="text" class="form-control" placeholder="Usuario" id="txtUsuario" name="txtUsuario" autocomplete="no">
