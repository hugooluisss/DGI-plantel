...
CREATE TABLE `aplicacion` (
  ...
  PRIMARY KEY (`idAplicacion`,`idUsuario`,`idExamen`),
  KEY `fk_usuarioAplicacion_idx` (`idUsuario`),
  KEY `fk_examenAplicacion_idx` (`idExamen`),
  CONSTRAINT `fk_examenAplicacion` FOREIGN KEY (`idExamen`) REFERENCES `examen` (`idExamen`) ON DELETE CASCADE ON UPDATE CASCADE,
