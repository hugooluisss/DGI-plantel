<?php /* Smarty version Smarty-3.1.11, created on 2016-10-14 10:31:53
...
?>
					<tr>
						...
						<td style="text-align: right">
							<button type="button" class="btn btn-warning" action="getData" title="Ver usuario y contraseña" datos='<?php echo $_smarty_tpl->tpl_vars['row']->value['json'];?>
